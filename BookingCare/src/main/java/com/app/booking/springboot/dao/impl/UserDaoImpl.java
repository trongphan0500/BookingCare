...
//		}
	...
	public User findPatient(String phone) throws Exception {
		...
		try {
			User patient =   (User) this.getSession().createQuery("SELECT U FROM User U WHERE U.phone = '"+phone+"'").getSingleResult();
			return patient;
		} catch (Exception e) {
	...
	public List<Patient> findPatientByName(String name) {
		// TODO Auto-generated method stub
		List<User> us =   (List<User>) this.getSession().createQuery("FROM User M WHERE M.name like '%"+name+"%' and M.roleId=5 ",User.class).list();
